...
ICON_CODEPOINTS: dict[str, int] = {
    ...
    # Analytics metrics
    "eye": 0xE0BA,        # eye (views)
    "heart": 0xE0F2,      # heart (likes)
    "message": 0xE116,    # message-circle (comments)
    "share": 0xE156,      # share-2 (shares)
    "trending": 0xE191,   # trending-up (comparison delta)
    # About / links
    "home": 0xE0F5,       # home (homepage)
    "code": 0xE093,       # code (repository)
    "book": 0xE05F,       # book-open (documentation)
    "bug": 0xE20C,        # bug (report issues)
    "filetext": 0xE0CC,   # file-text (changelog)
    "external": 0xE0B9,   # external-link (open link arrow)
}
