...
Page {
    ...
    property var gitLogData: {
        ...
        } catch(e) { console.error('AboutPage: failed to load git log', e) }
        return []
    }
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Repeater {
                            model: [
                                { label: "Homepage", icon: Icons.home, url: "https://github.com/TysAIs/xPST" },
                                { label: "Repository", icon: Icons.code, url: "https://github.com/TysAIs/xPST" },
                                { label: "Documentation", icon: Icons.book, url: "https://github.com/TysAIs/xPST#readme" },
                                { label: "Report Issues", icon: Icons.bug, url: "https://github.com/TysAIs/xPST/issues" },
                                { label: "Changelog", icon: Icons.filetext, url: "https://github.com/TysAIs/xPST/blob/main/CHANGELOG.md" }
                            ]
