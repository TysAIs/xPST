...
class IngestionQueue:
    ...
    def enqueue(self, source: str, *, workspace: str = "default",
        ...
        ``source_platform`` / ``source_post_id`` are optional provenance carried
        to the worker so drained nuggets can join performance history (Phase 4
        auto-ingest). They are ignored on the idempotent live-item path."""
