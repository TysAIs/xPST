...
<p align="center">
  ...
  <a href="#"><img alt="MCP Server" src="https://img.shields.io/badge/MCP-38%20tools-orange"></a>
...
- **CLI** — 44 top-level commands (66 including subcommands) covering the entire workflow
...
- **CLI** — 44 Click-based commands (66 including subcommands) with `--json` output, `--dry-run` mode, and meaningful exit codes
...
xPST provides 44 top-level commands (66 including subcommands). Run `xpst --help` for the full list. Most commands accept `--json` for machine-readable output, and the CLI auto-enables JSON mode when stdout is piped (non-TTY).
