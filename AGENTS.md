...
| **MCP** | `src/xpst/mcp/server.py` | 38 tools (post, health, config, state, platforms, scheduling, analytics, KB, captions, ideas, bio, transcripts, search, Messenger DM + comment auto-reply) |
