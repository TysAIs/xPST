...
| s3_out.json / s3_out_fixed.json | kill -9 mid-write x50 | No partial corruption ever (atomic rename holds); orphan tmp files accumulate | No corruption; stale tmps swept on init |
