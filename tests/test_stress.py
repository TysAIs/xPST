...
class TestInvalidInputs:
    ...
    def test_env_var_max_retries_not_a_number(self, tmp_path, monkeypatch):
...
class TestMissingFiles:
    ...
    def test_nonexistent_config_file(self):
        """Loading config from nonexistent file should raise."""
        with pytest.raises(FileNotFoundError):
            XPSTConfig.load("/nonexistent/path/config.yaml")
